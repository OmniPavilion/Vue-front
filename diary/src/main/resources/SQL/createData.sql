...
VALUES (1, '制定健身方案', '规划每周锻炼内容和目标', '2023-06-05', 4),
       (1, '购买健身器材', '购买哑铃和瑜伽垫', '2023-06-10', 2),
       (2, '需求分析', '收集并分析用户需求', '2023-05-10', 4),
       (2, 'UI设计', '设计用户界面原型', '2023-05-15', 3),
       (3, '阅读《代码大全》', '完成第1-5章阅读', '2023-05-15', 2),
       (3, '撰写读书笔记', '整理阅读收获', '2023-05-20', 2),
       (4, '背单词', '每天背诵50个单词', '2023-06-30', 3),
       (4, '听力练习', '每周完成3篇听力材料', '2023-06-30', 2),
       (4, '阅读英文原著', '每月阅读1本英文书籍', '2023-06-30', 2),
       (4, '写作练习', '每周写1篇英语作文', '2023-06-30', 1),
       (5, '确定旅行目的地', '选择东南亚国家', '2023-06-20', 4),
       (5, '预订机票', '比较航空公司价格', '2023-06-25', 2),
       (5, '安排行程', '制定每日活动计划', '2023-06-30', 3),
       (5, '预订住宿', '选择评分高的酒店', '2023-07-01', 2),
       (6, '学习云计算', '完成AWS认证课程', '2023-08-31', 2),
       (6, '参加技术会议', '报名行业峰会', '2023-07-15', 3),
       (6, '实践项目', '开发一个小型云应用', '2023-09-10', 1),
       (7, '设计装修风格', '确定现代简约风格', '2023-08-10', 4),
       (7, '选择装修公司', '对比3家装修公司报价', '2023-08-15', 2),
       (7, '采购装修材料', '列出材料清单', '2023-08-20', 2),
       (8, '制定预算表', '记录每月收支', '2023-06-10', 4),
       (8, '投资规划', '研究基金和股票', '2023-06-30', 3),
       (8, '应急资金储备', '存入3个月生活费', '2023-07-31', 2),
       (9, '制定食谱', '规划每日三餐', '2023-06-05', 4),
       (9, '采购食材', '购买新鲜蔬菜水果', '2023-06-07', 4),
       (10, '组织朋友聚会', '确定聚会时间和地点', '2023-06-20', 3),
       (10, '参加兴趣小组', '报名摄影俱乐部', '2023-06-18', 2);