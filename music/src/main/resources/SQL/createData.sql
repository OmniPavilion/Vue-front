...
-- 创建歌手图片表 singer_picture（优化版）
DROP TABLE IF EXISTS t_singer_picture;
CREATE TABLE IF NOT EXISTS t_singer_picture
(
    id        BIGINT AUTO_INCREMENT PRIMARY KEY,
    singer_id BIGINT NOT NULL,
    file_name TEXT   NOT NULL,
    FOREIGN KEY (singer_id) REFERENCES t_singer (id) ON DELETE CASCADE
) ENGINE = InnoDB;
...
(
    ...
    FOREIGN KEY (singer_id) REFERENCES t_singer (id) ON DELETE SET NULL,
