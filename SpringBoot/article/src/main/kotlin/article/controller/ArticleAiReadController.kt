...
class ArticleAiReadController(
    ...
    fun deleteByArticleId(@PathVariable articleId: Long): Result<Unit> {
        ...
        articleAiMemoryService.removeByConversationId(articleId)
        return Result.success()
    }
    ...
    fun getChatByArticleId(@PathVariable articleId: Long): Result<List<SpringAiChatMemory>> {
        ...
        val chatMemories = articleAiMemoryService.listByConversationId(articleId)
